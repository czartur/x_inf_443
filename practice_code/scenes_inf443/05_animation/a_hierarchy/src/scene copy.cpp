...
void scene_structure::initialize()
{
	...
	mesh_drawable body, head, eyes, beak, wing, wing_son;

	body.initialize_data_on_gpu(mesh_primitive_ellipsoid());
	head.initialize_data_on_gpu(mesh_primitive_sphere(0.5f));
	beak.initialize_data_on_gpu(mesh_primitive_cone(0.25));
